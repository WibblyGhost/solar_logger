...
class TestSecretStore:
    ...
    def test_passes_secret_store_reads_full_env(self, caplog: LogCaptureFixture):
    ...
    def test_passes_secret_store_reads_mqtt_env(self, caplog: LogCaptureFixture):
        caplog.set_level(logging.INFO)
    ...
    def test_passes_secret_store_reads_influx_env(self, caplog: LogCaptureFixture):
        caplog.set_level(logging.INFO)
    ...
    def test_fails_mqtt_env_contains_bad_port(self, caplog: LogCaptureFixture):
    ...
    def test_fails_secret_store_reads_none(self, caplog: LogCaptureFixture):
        caplog.set_level(logging.INFO)
    ...
    def test_fails_secret_store_reads_empty_mqtt_env(self, caplog: LogCaptureFixture):
        caplog.set_level(logging.CRITICAL)
    ...
    def test_fails_secret_store_reads_empty_influx_env(self, caplog: LogCaptureFixture):
        caplog.set_level(logging.CRITICAL)
    ...
    def test_fails_secret_store_empty_values(self, caplog: LogCaptureFixture):
        caplog.set_level(logging.CRITICAL)
